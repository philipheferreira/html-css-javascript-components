...
let clickarAtivarSubmitDoFormulario = () => {
	...
	// Criar objeto com os dados do usuario, mais organizado
	...
	// Converter o objeto para uma string (formato JSON), pois o sessionStorage sop armazena strings
	const dadosString = JSON.stringify(dadosFormulario);

	// Salvar a string no sessionStorage com uma chave (ex: 'dadosFormulario')
	sessionStorage.setItem('dadosFormulario', dadosString);

	console.log(`Informacoes de dados formulario foram passadas corretamente.\nPrimeiro Nome: ${dadosFormulario.primeiroNome}.\nUltimo nome: ${dadosFormulario.ultimoNome}.\nPais: ${dadosFormulario.pais}.\nIdade:${dadosFormulario.idade}.\nResumo: ${dadosFormulario.resumo}`)
