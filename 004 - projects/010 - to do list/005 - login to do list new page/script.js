...
2.Quando você clica em um botão type="submit" dentro de um <form>, o comportamento padrão do navegador é enviar 
o formulário e recarregar a página.
3.O seu JavaScript executa a função funcaoLogar(), mostra o alert e tenta mudar para home.html.
4.Mas, imediatamente depois, o navegador executa a sua ação padrão: recarregar a página atual. Esse 
recarregamento anula a sua tentativa de redirecionamento.
...
function funcaoLogar(){
	...
	if(login == "admin" && senha == "admin"){
		...
		location.href = "pages/toDoListPage.html";
